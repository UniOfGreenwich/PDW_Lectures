...
<!-- _footer: "[Download as a PDF](https://github.com/UniOfGreenwich/PDW_Lectures/raw/gh-pages/content/VersionControlSystem/versionControlSystem.pdf)" -->
...
`push​`: Pushes the current branch from local copy to remote.​
